...
# print(dados2018['equipes']['1']) teste
...
def qtos_libertadores(dados):
    qtd_times = str(dados['fases']['2700']['faixas-classificacao']['classifica1']['faixa'])
    qtd_times = qtd_times.split('-')

    return int(qtd_times[1])
...
print(dados2018['fases']['2700']['jogos']['id']['id_jogo']['time1'])
print(dados2018['fases']['2700']['jogos']['id']['102094']['time2'])
...
def nomes_dos_times_de_um_jogo(dados,id_jogo):
    ...
    nome_time_1 = nome_do_time(dados, ids[0])
    nome_time_2 = nome_do_time(dados, ids[1])
    nomes_times = [nome_time_1, nome_time_2]
...
# # teste retornar id a partir de nome comum

# for time in dados2018['equipes']:
#     print(dados2018['equipes'][time]['nome-comum'])

# print('\n\n\n\n\n')

def id_do_time(dados,nome_time):
    for time in dados['equipes']:
        if nome_time == dados['equipes'][time]['nome-comum']:
            return time
        else:
            pass
...
# teste datas de jogo
# for data in dados2018['fases']['2700']['jogos']['data']:
#     print(data)
...
'''
# testes data de um jogo
# dados2018['fases']['2700']['jogos']['id'][id_jogo]['data']
# print(dados2018['fases']['2700']['jogos']['id']['102094']['data'])

def data_de_um_jogo(dados,id_jogo):
    try:
        data_jogo = dados['fases']['2700']['jogos']['id'][id_jogo]['data']
        return data_jogo
    except:
        return 'nao encontrado'
...
'''
# testes dicionario id estadio e nro jogos
# id_jogos = dados2018['fases']['2700']['jogos']['id']
# jogos_id = dict()

# for jogo in id_jogos.values():
#     estadio_id = jogo['estadio_id']
    
#     if estadio_id not in jogos_id:
#         jogos_id[estadio_id] = 1  # Se o estádio não estiver no dicionário, inicia com 1
#     else:
#         jogos_id[estadio_id] += 1  # Se já estiver, incrementa o valor em 1
...
'''
# testes ids de jogos de um time
# id_jogos = dados2018['fases']['2700']['jogos']['id']#[id_jogo]
# id_time_escolhido = 1

# for id_jogo in id_jogos:
#     time_1 = id_jogos[id_jogo]['time1']
#     time_2 = id_jogos[id_jogo]['time2']
#     if str(id_time_escolhido) == time_1 or id_time_escolhido == time_2:
#         print(id_jogo)
#     else:
#         pass
# print('\n\n\n\n')
...
def ids_de_jogos_de_um_time(dados,time_id):
    id_jogos = dados['fases']['2700']['jogos']['id']#[id_jogo]
    jogos_participados = []
    for id_jogo in id_jogos:
        time_1 = id_jogos[id_jogo]['time1']
        time_2 = id_jogos[id_jogo]['time2']
        if time_id == time_1 or time_id == time_2:
            jogos_participados.append(id_jogo)
        else:
            pass
...
def datas_de_jogos_de_um_time(dados,nome_time):
    datas_de_jogos = []
    acesso_ids_jogos = dados['fases']['2700']['jogos']['id'] # para acessar os ids

    id_time = id_do_time(dados, nome_time) # para retornar o id a partir do nome comum
    ids_jogos_do_time = ids_de_jogos_de_um_time(dados, id_time) # para retornar os ids dos jogos que o time jogou

    for i in range(len(ids_jogos_do_time)):
        datas_de_jogos.append(acesso_ids_jogos[ids_jogos_do_time[i]]['data'])
    
    return datas_de_jogos
