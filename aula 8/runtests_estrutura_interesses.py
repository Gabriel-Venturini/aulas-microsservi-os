...
class TestStringMethods(unittest.TestCase):
    ...
    def test_p2_00_consulta_interesses_acha_algo(self):
        #reseto
        i.reseta()
        ...
        '''
        ==========================================================================================
        Se você tomar um keyerror nesse teste, talvez isso signifique que você,
        quando estava criando uma pessoa, não lembrou de criar a lista de interesses dela
        ==========================================================================================
        ''')
    ...
    '''
    def test_p2_04_interesse_com_pessoas_validas(self):
        #reseto
        i.reseta()
    ...
    def test_p2_05_consulta_interesse_com_pessoas_validas(self):
        #reseto
        i.reseta()
        
        
        try:
            i.consulta_interesses(9)
            #se chegar na linha de baixo, nao deu erro. Mas devia ter dado
            self.fail("consulta interesse devia ter dado erro, mas nao deu. Pessoa ainda nao existe!")
        except i.NotFoundError:
            #se der o erro NotFoundError, está tudo ok, nao preciso fazer nada
            pass
            ...
            erro = '''
            ==================================================================================
            uma Exception do tipo NotFoundError deveria ter ocorrido, mas ocorreu alguma outra
            veja abaixo
            ==================================================================================
            '''
            print(erro)
            
            #faço o erro ocorrer de novo pra você ver
            i.consulta_interesses(9)
        ...
        i.consulta_interesses(9)
        #se desse pau na funcao acima, o teste te avisaria. Se nao avisou, deu tudo certo
    ...
    def test_p3_01_lista_matches(self):
        #reseto
        i.reseta()
    ...
    def test_p3_02_lista_matches_com_pessoas_invalidas(self):
        #reseto
        i.reseta()
    ...
    def test_p3_03_lista_matches_com_match_perdido(self):
        #reseto
        i.reseta()
